        ...
        while(!rerun)
        {
            ...
            case 1:
                ...
                case 1:
                    ...
                    {
                        System.out.println("\t\t-------------------------------------------------------------------------------");
                        System.out.println("\t\tOops! we are out of stock.Please Login/Sign up to buy any other books  ");
                        System.out.println("\t\t-------------------------------------------------------------------------------");
            ...
            case 3:
                ...
                String uname0 = sc.next();
                System.out.print("\t\t\tEnter Reader Password: ");
                String upassword0 = sc.next();
                System.out.print("\t\t\tRe-enter Reader Password: ");
                String reupassword0 = sc.next();

                if(upassword0.equals(reupassword0))
                {

                    ufrwd.writeInFile("**" + nid0 + " " + name0 + " " +  age0 + " " + uname0 + " " + upassword0 + " *", "user");
