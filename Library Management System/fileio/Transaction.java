...
public  class Transaction implements ITransaction
{
    ...
    {   System.out.println("\t\t modded " + oldString + ">>>" + newString);
        File fileToBeModified = new File("E:\\AIUB (21-44630-1)\\Defense\\fileio\\Bank.txt");
        String oldContent = "";
    ...
    public  void withdraw (double amount, String accID)
    {
        ...
        try
        {
            FileInputStream ufin = new FileInputStream("E:\\AIUB (21-44630-1)\\Defense\\fileio\\Bank.txt");
