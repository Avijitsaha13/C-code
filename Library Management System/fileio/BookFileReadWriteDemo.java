...
public  class BookFileReadWriteDemo 
{
    private File ufile;
    ...
    {
        File fileToBeModified = new File("E:\\AIUB (21-44630-1)\\Defense\\fileio\\BOOK.txt");
        String oldContent = "";
    ...
    public void writeInFile(String s)
    {
        ...
        try
        {
            ufile = new File("E:\\AIUB (21-44630-1)\\Defense\\fileio\\BOOK.txt");
            ufile.createNewFile();
    ...
    public void writeTransactionHistory(String s)
    {
        ...
        try
        {
            ufile = new File("E:\\AIUB (21-44630-1)\\Defense\\fileio\\TransactionHistory.txt");
            ufile.createNewFile();
            uwriter = new FileWriter(ufile, true);
            uwriter.write(s + System.lineSeparator());
            uwriter.flush();
    ...
    public  void search (String line0)
    {
        ...
        try
        {
            FileInputStream ufin = new FileInputStream("E:\\AIUB (21-44630-1)\\Defense\\fileio\\BOOK.txt");
               ...
               // System.out.println("\t\tARRAY SIZE : "+retval.length+" "+retval[1]);
                if(line.contains(line0))
                {
                    if(retval[1].equals(line0) && delete==0)
                    {
                        ...
                        System.out.println("\t\tBook ISBN : " + retval[1]);
                        System.out.println("\t\tBook Title : " + retval[3]);
                        System.out.println("\t\tBook Author Name : " + retval[4]);
                        System.out.println("\t\tGenre : " + retval[9]);
    ...
    public void showHistory()
    {
        ...
        try
        {
            FileInputStream ufin = new FileInputStream("E:\\AIUB (21-44630-1)\\Defense\\fileio\\TransactionHistory.txt");
            Scanner sc = new Scanner(ufin);
            while (sc.hasNextLine())
            {
