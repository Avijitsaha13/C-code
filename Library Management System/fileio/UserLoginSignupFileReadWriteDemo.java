...
public class UserLoginSignupFileReadWriteDemo implements IUserLoginSignupFileReadWriteDemo
{
    ...
    public void writeInFile(String s, String loc)
    {
        ...
        try
        {
            ufile = new File("E:\\AIUB (21-44630-1)\\Defense\\fileio" + loc + ".txt");
            ufile.createNewFile();
    ...
    public  void info(String loc, String empId)
    {
        ...
        try
        {
            FileInputStream ufin = new FileInputStream("E:\\AIUB (21-44630-1)\\Defense\\fileio" + loc + ".txt");
    ...
    public  void pay(String cred, String uid)
    {
        ...
        this.writeInFile(uid + " Have deposited " + salary + "$ to account no. : " + cred + " And Have been Credited from account no. : *123*1 *", "TransactionHistory");
    ...
    public  void verify (String line0, String line1) //Login/Delete
    {
        ...
        try
        {
            FileInputStream ufin = new FileInputStream("E:\\AIUB (21-44630-1)\\Defense\\fileio\\user.txt");
            Scanner sc = new Scanner(ufin);
            while (sc.hasNextLine())
            {
                line = sc.nextLine();
    ...
    public void initiateReactify()
    {
        ...
        try
        {
            ...
            ufile = new File("E:\\AIUB (21-44630-1)\\Defense\\fileio\\otp.txt");
            ufile.createNewFile();
    ...
    public  void rectify (String name, String otp0)
    {
        ...
        try
        {
            ...
            FileInputStream ufin = new FileInputStream("E:\\AIUB (21-44630-1)\\Defense\\fileio\\user.txt");
            FileInputStream otp = new FileInputStream("E:\\AIUB (21-44630-1)\\Defense\\fileio\\otp.txt");
            Scanner sc = new Scanner(ufin);
    ...
    {
        File fileToBeModified = new File("E:\\AIUB (21-44630-1)\\Defense\\fileio\\user.txt");
        String oldContent = "";
            ...
            while (sc.hasNextLine())
            {
                ...
                if(line.contains(line0))
                {
                    if(retval[0].equals(line0))
                    {
                        ...
                        System.out.println("\t\tReader ID : " + retval[0]);
                        System.out.println("\t\tReader Name : " + retval[1]);
                        System.out.println("\t\tReader DOB : " + retval[2]);
                        System.out.println("\t\tReader username : " + retval[3]);


                    }
                    else if (retval[0].startsWith(line0)) //Showing all books
                    {
                        System.out.println("\t\t--ID Found--");
                        System.out.println("\t\tReader ID : " + retval[0]);
                        System.out.println("\t\tReader Name : " + retval[1]);
